...
%{\Huge VOLUME}
%\vfill
%{\scriptsize School of Cognitive Science, Institute for Research in Fundamental Sciences (IPM)}
%{\bf\textsc{Olfactory receptors of Drosophila are sensitive to molecular volume of odorants}\vspace{0.5em}} % Poster title
%{\bf{\Huge SCENT} 
%--------\ {\small OF A}\ --------
%{\Huge VOLUME}\vspace{0.5em}} % Poster title
...
\headerbox{}{name=title,column=1, row=0}{
...
Different scenarios that may happen when an odorant molecule meets a receptor:
\begin{center}
...
\headerbox{Methods}{name=methods,column=1, below=title
