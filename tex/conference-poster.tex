...
\documentclass[a1paper,fontscale=0.6]{baposter} % Adjust the font scale/size here
...
%----------------------------------------------------------------------------------------
%
{\includegraphics[height=5em]{fig/ecro2015_logo.jpg}} % First university/lab logo on the left
{\bf\textsc{Human olfactory receptors are sensitive to molecular volume of odorants}\vspace{0.5em}} % Poster title
...
\headerbox{Methods}{name=methods,column=1
